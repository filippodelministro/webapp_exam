...
function NewOrderLayout({ computationData, storageData, datatransferData, onOrderCreated}) {
  ...
  if (
    !computationData?.length ||
    !storageData?.length ||
    !datatransferData?.length
  ) {
    return <p>Loading order options...</p>;
  }

  const computation = computationData[0];
  const storage = storageData[0];
  const datatransfer = datatransferData[0];

  let totalPrice = null;
  try {
    if (ramGb) {
      totalPrice = computePrice( ramGb, storageTb, dataGb, computationData, storageData, datatransferData) * months;
    }
  } catch (err) {
    totalPrice = null;
  }
    ...
    <div className="mb-5">
      ...
      <Row className="g-4 mt-3">
        ...
        <Col md={3}>
          <Card>
            <Card.Body>
              <Card.Title>Computation</Card.Title>
              ...
              >
                ...
                <option value={computation.ramTier1}>
                  {computation.ramTier1} GB – €{computation.priceTier1}/month
                </option>
                <option value={computation.ramTier2}>
                  {computation.ramTier2} GB – €{computation.priceTier2}/month
                </option>
                <option value={computation.ramTier3}>
                  {computation.ramTier3} GB – €{computation.priceTier3}/month
                </option>
              </select>
            </Card.Body>
          </Card>
        ...
        <Col md={3}>
          <Card>
            <Card.Body>
              ...
              <input
                type="number"
                min={storage.minStorageTbPerOrder}
        ...
        <Col md={3}>
          <Card>
            <Card.Body>
              ...
              <small className="text-muted">GB per month</small>
            </Card.Body>
          </Card>
        </Col>
        ...
        <Col>
          <Card>
            <Card.Body className="d-flex justify-content-between align-items-center">
              ...
              <Button
                variant="success"
                disabled={!ramGb || loading}
                onClick={handleSubmit}
              >
                {loading ? <Spinner size="sm" /> : "Create order"}
              </Button>
            </Card.Body>
          </Card>
        </Col>
